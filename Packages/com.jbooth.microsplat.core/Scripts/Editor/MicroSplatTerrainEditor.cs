...
public partial class MicroSplatTerrainEditor : Editor
{
   ...
   public override void OnInspectorGUI()
   {
      ...
      // so this is looked up via name. People are also slopping about files, and end up with
...
#if __MICROSPLAT_PROCTEX__
      MicroSplatUtilities.DrawTextureField (t, biomeOverride, ref t.procBiomeMask, "_PCBIOMEMASK");
